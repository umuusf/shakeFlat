...
class dtUserOnePage extends DataTable
{
    protected function __construct()
    {
        ...
        parent::setSubmitForModifyCallback(function() {
            ...
            $param->checkKeyValue("sf-userlist-modify-pk", Param::TYPE_JSON);
            if (!array_key_exists("user_no", $param->get("sf-userlist-modify-pk"))) L::error("잘못된 접근입니다.");
            ...
            $db->query("
                ...
                where
                    user_no = :user_no
            ", [
                ":user_no"  => $param->get("sf-userlist-modify-pk")["user_no"],
